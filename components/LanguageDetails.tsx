function LanguageDetails({ title, Icon }) {
  return (
    <div className="group cursor-pointer  m-2 p-2 flex flex-col flex-1 text-center items-center justify-center h-24 w-28 bg-gray-100 dark:bg-gray-500 rounded-t-xl dark:text-darkcolor">
