...
const ProjectCard: FunctionComponent<{
  ...
  return (
    <div>
      ...
      {showDetail && (
        <div className="flex md:absolute sticky top-0 left-0 bg-white dark:bg-darkback h-auto w-full z-20  p-2  md:p-4 shadow-2xl border-2 rounded-xl dark:border-gray-600">
          <motion.div
            variants={stagger}
            initial="initial"
            animate="animate"
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="flex flex-col items-center justify-center m-1 mb-1"
            >
              <Image
                src={image_path}
                alt={name}
              ...
              <motion.div
                variants={fadeInUp}
                className="flex my-4 gap-3 justify-center "
              >
                <a
                  href={github_url}
                  target="_blank"
            ...
            <motion.div
              ...
              initial="initial"
              animate="animate"
              className="mx-2 md:mx-4 md:mt-4 mt:2"
            >
              ...
              <motion.div
                variants={fadeInUp}
                className=" flex flex-wrap mt-3 md:mt-5 space-x-2 tracking-wider "
              >
                {tech.map((item) => (
                  <span
                    className="bg-gray-200 dark:bg-gray-900 px-2 md:px-3 py-1 md:my-4 my-1"
                    key={item}
                  >
                    {item}
                  </span>
            ...
            <button onClick={() => setShowDetail(false)}>
              <IoIosClose className="h-8 w-8 absolute top-0 right-0 bg-gray-600 text-white rounded-full dark:bg-gray-700 m-2 focus:outline-none  transform hover:rotate-90 duration-500 " />
            </button>
          </motion.div>
        </div>
      )}
